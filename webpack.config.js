...
var lang = 'en';
if (process.argv && process.argv[7] && process.argv[7].startsWith('--env.lang=')) {
  lang = process.argv[7].substr(11);
}
...
module.exports = function makeWebpackConfig() {
   ...
   */
  config.resolve = {
    modules: [root('app'), root('public'), 'node_modules'],
  ...
  config.plugins = [
    ...
    new aotplugin.AotPlugin({
      ...
      i18nFile: lang !== 'en' ? './locale/messages.' + lang + '.xlf' : null,
      i18nFormat: 'xlf',
      locale: lang
    }),
